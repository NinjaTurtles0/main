        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              const Text("To be able to use your account, please verify your email"
                  " address using the link sent to your email email@email.com",
                  style: TextStyle(fontSize: 18,fontFamily: 'Montserrat.bold', color: Colors.white70)),
              const SizedBox(
                height: 370,
              ),
              const SizedBox(
